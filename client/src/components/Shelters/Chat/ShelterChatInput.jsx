    ...
    <div className="bg-[#31323e] border-t border-white/10 p-4 flex-shrink-0">
      ...
      <div className="flex items-center gap-2">
              ...
              <div className="flex mb-2 border-b border-white/10">
                <button
                  ...
                  className={`flex-1 py-1 text-sm ${
                    pickerMode === "emoji"
                      ? "text-white border-b-2 border-[#4a5568]"
                      : "text-white/50"
                  }`}
                >
                  Emoji
        ...
        <input
          ...
          className="flex-1 bg-[#1e202c] border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder-white/40 focus:outline-none focus:border-[#4a5568]/50 focus:ring-2 focus:ring-[#4a5568]/20 transition-all"
        />

        <button
          onClick={sendMessage}
          disabled={!messageInput.trim() && !imageFile}
          className="bg-[#4a5568] hover:bg-[#5a6678] p-2.5 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all hover:scale-105 active:scale-95 disabled:hover:scale-100"
          title="Send message"
        >
...
export default ShelterChatInput;
